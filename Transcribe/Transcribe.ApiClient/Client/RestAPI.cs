...
namespace Transcribe.ApiClient.Client
{
    ...
    public partial class TranscribeClient : SwaggerClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public TranscribeClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl;
        ...
        public virtual System.Threading.Tasks.Task<TranscribeResponse> UploadAsync(string language, System.IO.Stream body)
        {
            return UploadAsync(language, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Successful Response</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<TranscribeResponse> UploadAsync(string language, System.IO.Stream body, System.Threading.CancellationToken cancellationToken)
        {
            if (body == null)
                throw new System.ArgumentNullException("body");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/transcribe/upload?");
            if (language != null)
            {
    ...
    public partial class Body_upload_file_transcribe_upload_post
    {
        ...
        public static Body_upload_file_transcribe_upload_post FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<Body_upload_file_transcribe_upload_post>(data, new Newtonsoft.Json.JsonSerializerSettings());
    ...
    public partial class TranscribeResponse
    {
        ...
        public static TranscribeResponse FromJson(string data)
        {

            return Newtonsoft.Json.JsonConvert.DeserializeObject<TranscribeResponse>(data, new Newtonsoft.Json.JsonSerializerSettings());
